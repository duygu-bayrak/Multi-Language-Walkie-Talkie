...
class GUI:
    ...
    def initialize_socket(self):
        ...
        remote_ip = 'ec2-3-80-189-108.compute-1.amazonaws.com' # 127.0.0.1'  # IP address
...
# TODO: modify client to query database for a full update
# SELECT * from messages, order by timestamp and print each entry to textbox
